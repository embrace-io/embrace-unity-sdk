...
#ifndef EMBRACECAPTURESERVICE_SWIFT_H
#define EMBRACECAPTURESERVICE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="EmbraceCaptureService",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// A <code>CaptureService</code> is an object that can be passed to the Embrace during setup
...
SWIFT_CLASS_NAMED("CaptureService")
@interface EMBCaptureService : NSObject
