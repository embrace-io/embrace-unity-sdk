...
#ifndef EMBRACECOMMONINTERNAL_SWIFT_H
#define EMBRACECOMMONINTERNAL_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="EmbraceCommonInternal",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC21EmbraceCommonInternal11CrashReport")
...
SWIFT_PROTOCOL("_TtP21EmbraceCommonInternal13CrashReporter_")
...
SWIFT_CLASS("_TtC21EmbraceCommonInternal20CrashReporterContext")
...
SWIFT_PROTOCOL("_TtP21EmbraceCommonInternal14InternalLogger_")
@protocol InternalLogger
