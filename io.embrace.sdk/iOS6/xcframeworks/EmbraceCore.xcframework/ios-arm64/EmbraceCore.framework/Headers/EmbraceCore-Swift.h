...
SWIFT_CLASS("_TtC11EmbraceCore24DefaultPowerModeProvider")
@interface DefaultPowerModeProvider : NSObject
...
@property (nonatomic, readonly, copy) NSArray<CaptureService *> * _Nonnull services;
...
///
- (nonnull instancetype)initWithAppId:(NSString * _Nonnull)appId appGroupId:(NSString * _Nullable)appGroupId platform:(enum EMBPlatform)platform endpoints:(EMBEndpoints * _Nullable)endpoints captureServices:(NSArray<CaptureService *> * _Nonnull)captureServices crashReporter:(id <CrashReporter> _Nullable)crashReporter logLevel:(enum LogLevel)logLevel export:(EMBOpenTelemetryExport * _Nullable)export_ OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_RESILIENT_CLASS("_TtC11EmbraceCore30LowMemoryWarningCaptureService")
@interface LowMemoryWarningCaptureService : CaptureService
- (void)onInstall;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_RESILIENT_CLASS("_TtC11EmbraceCore26LowPowerModeCaptureService")
@interface LowPowerModeCaptureService : CaptureService
- (void)onInstall;
- (void)onStart;
- (void)onStop;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
...
/// Automatically generates span events when notifications are received through the <code>UNUserNotificationCenter</code>.
...
SWIFT_RESILIENT_CLASS("_TtC11EmbraceCore17TapCaptureService")
@interface TapCaptureService : CaptureService
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)onInstall;
@end
...
SWIFT_RESILIENT_CLASS("_TtC11EmbraceCore24URLSessionCaptureService")
@interface URLSessionCaptureService : CaptureService
...
@interface URLSessionCaptureService (SWIFT_EXTENSION(EmbraceCore))
@end

@protocol URLSessionRequestsDataSource;

/// Class used to setup a URLSessionCaptureService.
SWIFT_CLASS("_TtCC11EmbraceCore24URLSessionCaptureService7Options")
...
SWIFT_RESILIENT_CLASS("_TtC11EmbraceCore18ViewCaptureService")
@interface ViewCaptureService : CaptureService
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)onInstall;
@end
...
/// Automatically generates span events when a <code>WKWebView</code> loads an URL or throws an error.
SWIFT_RESILIENT_CLASS("_TtC11EmbraceCore21WebViewCaptureService")
@interface WebViewCaptureService : CaptureService
...
@interface WebViewCaptureService (SWIFT_EXTENSION(EmbraceCore))
@end
