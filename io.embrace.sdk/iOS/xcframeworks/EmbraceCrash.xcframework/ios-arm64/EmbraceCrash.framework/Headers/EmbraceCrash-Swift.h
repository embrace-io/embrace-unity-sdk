...
#ifndef EMBRACECRASH_SWIFT_H
#define EMBRACECRASH_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="EmbraceCrash",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// Default <code>CrashReporter</code> used by the Embrace SDK.
/// Internally uses KSCrash to capture data from crashes.
SWIFT_CLASS_NAMED("EmbraceCrashReporter")
@interface EMBEmbraceCrashReporter : NSObject <CrashReporter>
