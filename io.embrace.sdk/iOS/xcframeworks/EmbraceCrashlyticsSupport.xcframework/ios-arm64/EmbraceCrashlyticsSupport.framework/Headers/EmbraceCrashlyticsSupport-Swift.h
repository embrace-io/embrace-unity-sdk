...
#ifndef EMBRACECRASHLYTICSSUPPORT_SWIFT_H
#define EMBRACECRASHLYTICSSUPPORT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="EmbraceCrashlyticsSupport",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS_NAMED("CrashlyticsReporter")
@interface EMBCrashlyticsReporter : NSObject <CrashReporter>
